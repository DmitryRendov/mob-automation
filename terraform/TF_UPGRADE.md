...
#### We need docs
A potential casualty of upgrading Terraform is [terraform-config-inspect](https://github.com/hashicorp/terraform-config-inspect). We have a forked version that has been modified, and often times, is out of date with the upstream. Some changes to Terraform
